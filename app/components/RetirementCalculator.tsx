            ...
            <div className={`retirement-results ${showResults ? 'results-visible' : ''}`}>
              ...
              <div className="results-grid">
                <div className="result-card">
                  ...
                  <span className="result-value result-green">{fmt(results.totalSavings)}</span>
                </div>
                <div className="result-card">
                  <span className="result-label">Required Nest Egg</span>
                  <span className="result-value">{fmt(results.requiredNest)}</span>
                </div>
                <div className="result-card">
                  <span className="result-label">Monthly Income at Retirement</span>
                  <span className="result-value result-green">{fmt(results.monthlyIncome)}</span>
                </div>
                <div className="result-card">
                  <span className="result-label">Inflation-Adjusted Expenses</span>
                  <span className="result-value">{fmt(results.adjustedExpenses)}/mo</span>
                </div>
                <div className="result-card">
              ...
              {!results.onTrack && (
                <div className="gap-warning">
                  <p>You need an additional <strong>{fmt(results.savingsGap)}</strong> to meet your retirement goal.</p>
                  <p>Consider increasing your monthly contribution or adjusting your retirement age.</p>
                </div>
              )}

              {/* CTA */}
              <a href="/book-appointment" className="results-cta">
